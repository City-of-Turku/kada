(function ($) {
   ...
   */
  Drupal.theme.prototype.driveturkuExampleButton = function (path, title) {
  ...
  Drupal.behaviors.driveturkuQuicktabs = {
    attach: function () {
  ...
  Drupal.behaviors.driveturkuMainMenuBehavior = {
    attach: function (context) {
      switchMainMenuBehavior(context);
    }
  };

  Drupal.behaviors.driveturkuEqualHeightsBehavior = {
    attach: function (context) {
      $(window).load(function () {
        var resizeOk = true;
  ...
  // Help region toggler
  Drupal.behaviors.driveturkuToolsToggle = {
    attach: function (context) {
  ...
  Drupal.behaviors.driveturkuTopMenuMobile = {
    attach: function (context) {
  ...
  // Font zoom
  Drupal.behaviors.driveturkuFontZoom = {
    attach: function () {
      var fontSizes = [];
  ...
  Drupal.behaviors.driveturkuLanguageSwitcher = {
    attach: function () {
  ...
  Drupal.behaviors.driveturkuRecommendedToggle = {
    attach: function () {
  ...
  // Mobile tables
  Drupal.behaviors.driveturkuTableMobilize = {
    attach: function (context) {
  ...
  Drupal.behaviors.driveturkuEnhanceTaxonomyTermReferenceField = {
    attach: function (context) {
  ...
  // Enhance checkboxes
  Drupal.behaviors.driveturkuEnhanceCheckboxes = {
    attach: function (context) {
  ...
  Drupal.behaviors.driveturkuEnhanceRadioButtons = {
    attach: function (context) {
  ...
  Drupal.behaviors.driveturkuEnhanceRangeOfRepeat = {
    attach: function (context) {
  ...
  // External event form
  Drupal.behaviors.driveturkuExternalEventForm = {
    attach: function (context) {
  ...
  // Quick search toggle
  Drupal.behaviors.driveturkuQuickSearchToggle = {
    attach: function (context) {
  ...
  // News archive link
  Drupal.behaviors.driveturkuNewsArchiveLink = {
    attach: function (context) {
  ...
  Drupal.behaviors.driveturkuEventTabs = {
    attach: function (context) {
  ...
  Drupal.behaviors.driveturkuEventFilters = {
    attach: function (context) {
  ...
  Drupal.behaviors.driveturkuEventQuicksearch = {
    attach: function (context) {
  ...
  Drupal.behaviors.driveturkuEventFooter = {
    attach: function (context) {
  ...
  Drupal.behaviors.driveturkuSectionFooterContactInfo = {
    attach: function (context) {
  ...
  Drupal.behaviors.driveturkuSearchFiltersMobile = {
    attach: function (context) {
